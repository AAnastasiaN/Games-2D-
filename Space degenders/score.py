...
class Scores():
    ...
    def image_guns(self):
        # показывает сколько осталось жизней
        self.guns = Group()
    ...
    def image_score(self):
        ...
        self.score_img = self.font.render(str(self.stats.score), True, self.text_color, (220,220,220))
    ...
    def image_high_score(self):
        ...
        self.high_score_image = self.font.render(str(self.stats.high_score), True, self.text_color, (220,220,220))
